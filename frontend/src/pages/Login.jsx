...
//   return (
//     <div className="min-h-screen min-w-screen flex items-center justify-center bg-gray-50 p-6">
//       <div className="w-full max-w-2xl bg-white rounded-2xl shadow-md overflow-hidden">
//         <div className="px-6 py-4 border-b">
//           <h2 className="text-2xl font-semibold text-gray-800">Sign In</h2>
//           <p className="text-sm text-gray-500 mt-1">Sign in as User or Service Provider</p>
//         </div>
...
//                   Remember me
//                 </label>
//                 <a className="text-sm text-blue-600 hover:underline" href="#forgot">Forgot password?</a>
//               </div>
...
//           Don't have an account? <a className="text-blue-600 hover:underline" href="/register">Register here</a>
//         </div>
//       </div>
//     </div>
//   );
